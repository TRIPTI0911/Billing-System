                          ...
                          <table className="min-w-full text-sm">
                            ...
                            <tbody className="divide-y divide-green-100">
                              {(data.party.payments || []).length === 0 ? (
                                <tr>
                                  <td className="px-4 py-3 text-gray-500" colSpan={5}>No party payments found.</td>
                                </tr>
                              ) : (
                                data.party.payments.map((payment) => (
                                  <tr key={payment.id}>
                                    ...
                                    <td className="px-4 py-2">{formatCurrency(payment.total_amount)}</td>
                                    <td className="px-4 py-2">{formatCurrency(payment.remaining_amount)}</td>
                                  </tr>
                                ))
                              )}
                            </tbody>
                          ...
                          <table className="min-w-full text-sm">
                            ...
                            <tbody className="divide-y divide-orange-100">
                              {(data.factory.payments || []).length === 0 ? (
                                <tr>
                                  <td className="px-4 py-3 text-gray-500" colSpan={5}>No factory payments found.</td>
                                </tr>
                              ) : (
